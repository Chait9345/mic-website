import imgRectangle23 from "figma:asset/b8f87d8705ff501693f6aac0afab9deb2cdf7e88.png";

function Frame18() {
  return (
    <div className="absolute box-border content-stretch flex flex-col gap-[10px] items-center justify-center left-[6px] pl-0 pr-[10px] py-[10px] top-[63px] w-[54px]">
      <p className="font-['Poppins:Regular',_sans-serif] leading-[normal] not-italic relative shrink-0 text-[#ff730e] text-[20px] text-nowrap whitespace-pre">1/4</p>
    </div>
  );
}

export default function Frame130() {
  return (
    <div className="bg-[#d9d9d9] relative size-full">
      ...
      <Frame18 />
      <p className="absolute font-['Poppins:Regular',_sans-serif] leading-[normal] left-[12px] not-italic text-[#232a91] text-[32px] text-nowrap top-[103px] whitespace-pre">Idea Café</p>
      <div className="absolute h-[138px] left-[16px] top-[296px] w-[317px]">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[155.31%] left-0 max-w-none top-[-56.01%] w-full" src={imgRectangle23} />
        </div>
      </div>
      <p className="absolute font-['Roboto:Regular',_sans-serif] font-normal leading-[normal] left-[15px] text-[#9f9f9f] text-[12px] top-[173px] w-[285px]" style={{ fontVariationSettings: "'wdth' 100" }}>

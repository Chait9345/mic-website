import svgPaths from "./svg-fk4ngsz8fk";
...
function Frame22() {
  return (
    <div className="absolute box-border content-stretch flex gap-[10px] items-center justify-center left-[463px] p-[10px] top-[79px]">
...
function Frame28() {
  return (
    <div className="absolute box-border content-stretch flex gap-[10px] items-center justify-center left-[333px] p-[10px] top-[79px]">
...
function Frame23() {
  return (
    <button className="absolute box-border content-stretch cursor-pointer flex gap-[10px] items-center justify-center left-[594px] overflow-visible p-[10px] top-[79px]">
      <p className="font-['Share_Tech:Regular',_sans-serif] leading-[normal] not-italic relative shrink-0 text-[#030303] text-[20px] text-nowrap whitespace-pre">Labs + Programs</p>
    </button>
  );
}
...
function Frame24() {
  return (
    <div className="absolute box-border content-stretch flex gap-[10px] items-center justify-center left-[810px] p-[10px] top-[79px]">
...
function Frame25() {
  return (
    <button className="absolute box-border content-stretch cursor-pointer flex gap-[10px] items-center justify-center left-[963px] overflow-visible p-[10px] top-[79px]">
...
function Frame26() {
  return (
    <button className="absolute box-border content-stretch cursor-pointer flex gap-[10px] items-center justify-center left-[1100px] overflow-visible p-[10px] top-[79px]">
      <p className="font-['Share_Tech:Regular',_sans-serif] leading-[normal] not-italic relative shrink-0 text-[#030303] text-[20px] text-nowrap whitespace-pre">Contact</p>
    </button>
  );
}
...
function Frame2() {
  return (
    <div className="absolute bg-[#232a91] box-border content-stretch flex flex-col gap-[10px] items-start left-[770px] overflow-clip p-[4px] top-[468px] w-[115px]">
      <Frame3 />
    </div>
  );
}
...
function MdiHamburgerMenu() {
  return (
    <div className="absolute left-[1376px] size-[37px] top-[68px]" data-name="mdi:hamburger-menu">
...
function Frame41() {
  return (
    <div className="absolute box-border content-stretch flex gap-[10px] items-center left-[56px] p-[10px] top-[49px]" role="button" tabIndex="0">
      <Frame29 />
    </div>
  );
}
...
function Instagram() {
  return (
    <div className="absolute left-[76px] top-[956px]" data-name="Instagram" role="link" tabIndex="0">
...
function Facebook() {
  return (
    <div className="absolute left-[191px] top-[956px]" data-name="Facebook" role="link" tabIndex="0">
      <div className="box-border content-stretch flex gap-[10px] items-center overflow-clip p-[7px] relative rounded-[inherit]">
...
function X() {
  return (
    <div className="absolute left-[307px] size-[95px] top-[956px]" data-name="X">
...
function Frame12() {
  return (
    <a className="absolute bg-[#232a91] block cursor-pointer h-[1232px] left-0 overflow-clip top-[4423px] w-[1515px]" href="https://x.com/ic_mahe?lang=en">
...
function Lifeathon20() {
  return (
    <div className="absolute bg-[#ededed] box-border content-stretch flex flex-col gap-[30px] h-[542px] items-start left-[536px] px-[20px] py-[16px] top-[1718px] w-[440px]" data-name="Lifeathon 2.0">
      <Frame9 />
...
function Frame18() {
  return (
    <div className="content-stretch flex gap-[24px] items-center overflow-x-auto overflow-y-clip relative shrink-0 w-[1512px]">
      <Frame11 />
      <Frame13 />
      <Frame14 />
      <Frame15 />
...
function Frame20() {
  return (
    <div className="absolute box-border content-stretch flex gap-[10px] items-start left-[3px] px-0 py-[10px] top-[2944px] w-[1512px]">
      <Frame19 />
    </div>
  );
}
...
function Frame92() {
  return (
    <div className="absolute bg-[#ededed] box-border content-stretch flex flex-col gap-[30px] h-[542px] items-start left-[996px] px-[20px] py-[16px] top-[1718px] w-[440px]">
      <Frame21 />
...
function Lifeathon21() {
  return (
    <div className="absolute bg-[#ededed] box-border content-stretch flex flex-col gap-[30px] h-[542px] items-start left-[76px] px-[20px] py-[16px] top-[1718px] w-[440px]" data-name="Lifeathon 2.0">
      <Frame10 />
...
export default function MacBookPro142() {
  return (
    <div className="bg-[#fffffd] relative size-full" data-name="MacBook Pro 14' - 2">
      <Frame22 />
      <Frame28 />
      <Frame23 />
      <Frame24 />
      ...
      <p className="absolute font-['Roboto:Regular',_sans-serif] font-normal leading-[normal] left-[1325px] text-[#757575] text-[24px] top-[2283px] w-[102px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        View All
      </p>
      ...
      <Group1 />
      <div className="absolute left-[406px] size-[63px] top-[2677px]" data-name="image 1">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[124.88%] left-0 max-w-none top-[-4.92%] w-full" src={imgImage1} />
        </div>
      </div>
      <div className="absolute h-[243px] left-[422px] top-[589px] w-[324px]" data-name="image 2">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgImage2} />
      </div>
      <div className="absolute h-[552px] left-[76px] top-[589px] w-[325px]" data-name="image 3">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[148.38%] left-[-3.76%] max-w-none top-[-25.32%] w-[116.3%]" src={imgImage3} />
        </div>
      </div>
      <div className="absolute h-[552px] left-[996px] top-[589px] w-[440px]" data-name="image 4">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-full left-[-33.18%] max-w-none top-0 w-[167.27%]" src={imgImage4} />
        </div>
      </div>
      <Lifeathon20 />
      <div className="absolute h-[232px] left-[766px] top-[909px] w-[210px]" data-name="image 5">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      <Frame44 />
      <div className="absolute left-[76px] size-[137px] top-[43px]" data-name="DesignathonLogo 3">

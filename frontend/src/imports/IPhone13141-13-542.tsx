import svgPaths from "./svg-cjplz4bzws";
...
function Frame93() {
  return (
    <div className="absolute bg-[#232a91] box-border content-stretch flex gap-[10px] items-start left-[20px] overflow-clip p-[4px] top-[403px] w-[350px]">
      <Frame3 />
    </div>
  );
}
...
function Frame101() {
  return (
    <div className="absolute bg-[#ededed] box-border content-stretch flex flex-col gap-[10px] h-[355px] items-start left-[20px] px-0 py-[17px] top-[979px] w-[350px]">
      <Frame100 />
    </div>
  );
}
...
function Frame102() {
  return (
    <div className="absolute bg-[#ededed] box-border content-stretch flex flex-col gap-[10px] h-[355px] items-start left-[21px] px-0 py-[17px] top-[1370px] w-[350px]">
      <Frame107 />
    </div>
  );
}
...
function Frame103() {
  return (
    <div className="absolute bg-[#ededed] box-border content-stretch flex flex-col gap-[10px] h-[355px] items-start left-[21px] px-0 py-[17px] top-[1761px] w-[350px]">
      <Frame109 />
    </div>
  );
}
...
function Frame97() {
  return (
    <div className="absolute box-border content-stretch flex gap-[10px] items-center justify-center left-[283px] p-[10px] top-[926px]">
...
function Frame104() {
  return (
    <div className="absolute bg-[#232a91] h-[1040px] left-0 overflow-clip top-[3036px] w-[389px]">
      <Instagram />
      <Group18 />
      <Facebook />
      <X />
...
export default function IPhone13141() {
  return (
    <div className="bg-white relative size-full" data-name="iPhone 13 & 14 - 1">
